...
with st.sidebar:
    ...
    st.markdown(f"<div style='text-align: center; font-size: 0.75rem; color: {DARK_BLUE};'>Institutional Analytics v2.6</div>", unsafe_allow_html=True)
        ...
        if not data.empty:
            ...
            try:
                ...
                with tabs[0]:
                    ...
                    fig.add_trace(go.Scatter(x=f_dates, y=arima_fc, name="ARIMA Projection", line=dict(color="orange", dash='dot', width=3)))
